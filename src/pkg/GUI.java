...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelDirectory.setBackground(new java.awt.Color(204, 204, 255));
        ...
        textDestinationDirectoryPath.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        textSourceDirectoryPath.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        panelDirectoryLayout.setHorizontalGroup(
            ...
            .addGroup(panelDirectoryLayout.createSequentialGroup()
                ...
                .addGroup(panelDirectoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(textSourceDirectoryPath, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(textDestinationDirectoryPath))
                .addGap(10, 10, 10))
        );
        ...
        panelRename.setBackground(new java.awt.Color(204, 204, 255));

        textIncrementBy.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        checkboxKeepFileName.setBackground(new java.awt.Color(204, 204, 255));
        checkboxKeepFileName.setText("KeepFileName");

        checkboxIndexWithZero.setBackground(new java.awt.Color(204, 204, 255));
        checkboxIndexWithZero.setText("IndexWithZero");

        textSuffix.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        textDelimiter.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        buttonRename.setBackground(new java.awt.Color(138, 138, 230));
        ...
        buttonRenameDefault.setBackground(new java.awt.Color(138, 138, 230));
        ...
        radioButtonSortLastModified.setBackground(new java.awt.Color(204, 204, 255));
        ...
        textPrefix.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        textIndexStart.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        radioButtonSortFileName.setBackground(new java.awt.Color(204, 204, 255));
        radioButtonSortFileName.setText("FileName");

        checkboxSortReverse.setBackground(new java.awt.Color(204, 204, 255));
        checkboxSortReverse.setText("Reverse");

        panelFilter.setBackground(new java.awt.Color(204, 204, 255));

        textPhrase.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        buttonFilter.setBackground(new java.awt.Color(138, 138, 230));
        ...
        radioButtonFilterReplace.setBackground(new java.awt.Color(204, 204, 255));
        ...
        radioButtonFilterDelete.setBackground(new java.awt.Color(204, 204, 255));
        radioButtonFilterDelete.setText("Delete");

        radioButtonFilterDeleteWith.setBackground(new java.awt.Color(204, 204, 255));
        radioButtonFilterDeleteWith.setText("With");

        radioButtonFilterDeleteWithout.setBackground(new java.awt.Color(204, 204, 255));
        radioButtonFilterDeleteWithout.setText("Without");

        radioButtonFilterRemove.setBackground(new java.awt.Color(204, 204, 255));
        radioButtonFilterRemove.setText("Remove");

        textReplace.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 138, 230)));
        ...
        buttonFilterDefault.setBackground(new java.awt.Color(138, 138, 230));
        ...
        panelDelete.setBackground(new java.awt.Color(204, 204, 255));

        buttonDelete.setBackground(new java.awt.Color(138, 138, 230));
        ...
        buttonMove.setBackground(new java.awt.Color(138, 138, 230));
        ...
        panelBackgroundLayout.setHorizontalGroup(
            ...
            .addGroup(panelBackgroundLayout.createSequentialGroup()
                .addGroup(panelBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(panelDirectory, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
